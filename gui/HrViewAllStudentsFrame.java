 ...
 * @author Dell
 */
public class HrViewAllStudentsFrame extends javax.swing.JFrame {

    private List<ParticipantPojo> AllStudentsList;
    DefaultTableModel model;
    public HrViewAllStudentsFrame() {
        initComponents();
    ...
    private void initComponents() {
        ...
        tblAllOpenJobs.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Student Name", "UserID", "ID", "Phone no", "Qualification", "Skills"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HrViewAllStudentsFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
